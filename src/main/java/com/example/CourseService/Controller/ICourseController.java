...
import com.example.CourseService.DTO.ResponeCourseProfitDTO;
...
public interface ICourseController {
    ...
    ResponeCourseDTO createCourse(@RequestBody CreateCourseDTO dto) throws AppServiceExeption, IOException;
